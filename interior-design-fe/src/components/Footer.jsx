export default function Footer(){
  return(
    <div id="footer"
      className="relative w-[100vw] !text-[#1C1C1C]"
    >
      <div className="flex flex-col w-full h-full text-3xl items-center justify-top bg-[#C6A982]">
        ...
        <div className="w-full flex flex-col justify-center items-center py-4">
          <div className="grid grid-cols-2 gap-8 w-[90vw] mx-auto">
            <div>
              <ul className="space-y-1 text-lg font-light">
            ...
            <div>
              <ul className="space-y-1 text-lg font-light text-right">
        ...
        <div className="w-full flex flex-col justify-center items-center py-4">
          <div className="grid grid-cols-2 gap-2 w-[90vw] mx-auto text-lg">
            ...
            <div className="h-full text-base text-gray-600">
        ...
        <div className="w-full flex flex-col justify-center items-center py-4">
          <div className="grid grid-cols-2 gap-2 w-[90vw] mx-auto text-sm text-gray-600">
